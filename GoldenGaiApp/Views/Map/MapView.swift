...
// MARK: - SortOption Enum (was missing)

enum SortOption: String, CaseIterable {
    case nameAscending = "Name (A-Z)"
    case nameDescending = "Name (Z-A)"
    case visitedFirst = "Visited First"
    case unvisitedFirst = "Unvisited First"
    ...
    var sortDescriptors: [SortDescriptor] {
        ...
        case .visitedFirst:
            return [SortDescriptor(key: "visited", ascending: false), SortDescriptor(key: "name", ascending: true)]
        case .unvisitedFirst:
            return [SortDescriptor(key: "visited", ascending: true), SortDescriptor(key: "name", ascending: true)]
        case .recentlyVisited:
            return [SortDescriptor(key: "visitedDate", ascending: false), SortDescriptor(key: "name", ascending: true)]
        }
    }
}
